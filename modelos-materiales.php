  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <img src="./img/final-greenguard.jpg" class="rounded" width="99%" alt="">
            <h5 class="card-title mt-4 font-weight-bold">Greenguard®</h5>
            <p class="card-text">Este producto aporta un porcentaje mínimo de emisiones que contribuye a crear ambientes interiores saludables.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <img src="./img/final-reciclado.jpg" class="rounded" width="99%" alt="">
            <h5 class="card-title mt-4 font-weight-bold">Reciclado</h5>
            <p class="card-text">Con un porcentaje del 12% de material reciclado, el compromiso es avanzar en el camino de operaciones sustentables.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <img src="./img/final-forest.jpg" class="rounded" width="99%" alt="">
            <h5 class="card-title mt-4 font-weight-bold">LEED</h5>
            <p class="card-text">La celulosa del fenólico proviene de bosques certificados lo que contribuye a la obtención de puntos LEED.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3 mb-5">
        <div class="card h-100">
          <div class="card-body">
            <img src="./img/final-autoextinguible.jpg" class="rounded" width="99%" alt="">
            <h5 class="card-title mt-4 font-weight-bold">Más seguro</h5>
            <p class="card-text">Producto y experiencia seguros, confiables y sostenibles. Material Retardante al fuego, auotoextinguible.</p>
          </div>
        </div>
      </div>
    </div>
