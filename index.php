...
?>
  ...
  <div class="container">
    <div class="row align-items-center my-5">
      <div class="col-lg-6">
        <h1 class="font-weight-bold py-2">Modelos y Materiales</h1>
    ...
    <div class="row align-items-center my-5">
      <div class="col-lg-6">
        <img class="img-fluid rounded mb-4 mb-lg-0" src="./img/m02.jpg" alt="Colores y Acabados de Mampras" /></div>
      <div class="col-lg-6">
    ...
    <div class="row align-items-center my-5">
      ...
      <div class="col-lg-7">
        ...
        <p>This is a template that is great for small businesses. It doesn't have too much fancy flare to it, but it
          makes a great use of the standard Bootstrap core components. Feel free to use this template for any project
          you want!</p>
        <a class="btn btn-outline-primary" href="agenda.pho">Agendar</a>
      </div>
      <div class="col-lg-3">
